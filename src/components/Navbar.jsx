...
const Navbar = () => {
  ...
  return (
    ...
    <div>
        <h1 className='text-5xl font-signature ml-2'>Yash Deharia</h1>
    </div>
    ...
    {nav && (
        <ul className='flex flex-col justify-center items-center absolute top-0 left-0 w-full h-screen bg-gradient-to-b from-white  text-black-500 '>
